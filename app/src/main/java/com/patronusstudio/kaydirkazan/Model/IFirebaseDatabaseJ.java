...
public class IFirebaseDatabaseJ {
    ...
    void kullanicilari_sirala(ArrayList<Integer> liste, int kullanicinin_puani, FirebaseContractJ.KullaniciIslemleri.siralamasi sonuc) {
    ...
    public void sorulari_cek(final FirebaseContractJ.SoruListesi sonuc) {
        ...
        switch (random_sayi) {
            case 0:
                firebaseDatabase_sorular = firebaseDatabase_sorular.child(FirebaseKeyJ.TAHMIN_ET);
                break;
            case 1:
                firebaseDatabase_sorular = firebaseDatabase_sorular.child(FirebaseKeyJ.TAHMIN_ET);
                break;
            case 2:
                ...
                break;
            case 3:
                firebaseDatabase_sorular = firebaseDatabase_sorular.child(FirebaseKeyJ.REKORLAR);
                break;
            case 4:
                firebaseDatabase_sorular = firebaseDatabase_sorular.child(FirebaseKeyJ.GENEL_KULTUR);
                break;
            case 5:
                firebaseDatabase_sorular = firebaseDatabase_sorular.child(FirebaseKeyJ.GENEL_KULTUR);
                break;
            case 6:
                firebaseDatabase_sorular = firebaseDatabase_sorular.child(FirebaseKeyJ.NE_ZAMAN);
                break;
        }
    ...
    void soruListesiRandom(ArrayList<soruModelJ> soruListesi, FirebaseContractJ.SoruListesi sonuc) {
